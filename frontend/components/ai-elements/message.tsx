...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      ...
      'group-[.is-assistant]:bg-blue-50 group-[.is-assistant]:text-foreground group-[.is-assistant]:rounded-lg group-[.is-assistant]:px-4 group-[.is-assistant]:py-3 group-[.is-assistant]:mr-auto group-[.is-assistant]:border group-[.is-assistant]:border-blue-100',
      className
    )}
    {...props}
  >
